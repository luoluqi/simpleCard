...
Component({
  ...
  methods: {
    ...
    addApp:function(e){
      ...
      var applets_name = wx.getStorageSync("applets_name");
      const index = e.currentTarget.dataset.index;
      var node = {
        name: "app",
        desc: applets_name == "" ? "小程序名字（未设置）" : applets_name,
        content: ""
      }
    ...
    addCopy:function(e){
      ...
      nodeList.splice(index + 1, 0, node);
      textBufferPool.splice(index + 1, 0, node);
      this.setData({
        nodeList,
        textBufferPool,
        addIndex: -2,
