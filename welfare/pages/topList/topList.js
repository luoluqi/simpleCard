...
Page({
   ...
   */
  onShow: function () {
    var I_JOIN_ACTIVE = wx.getStorageSync("I_JOIN_ACTIVE");
    for(var i in this.data.startList){
      var active = this.data.startList[i];
      if (active.active_id == I_JOIN_ACTIVE){
        var obj = {};
        obj["startList["+i+"].apply_status"] = 1;
        this.setData(obj);
      }
    }
  },
